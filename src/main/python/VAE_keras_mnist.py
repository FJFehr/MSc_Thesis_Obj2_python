...
if __name__ == '__main__':
    ...
    intermediate_dim = 512 # first layer
    batch_size = 1000
    latent_dim = 2
    epochs = 200
    ...
    training_history = vae.fit(x_train, epochs=epochs, batch_size=batch_size, validation_data=(x_test, None), callbacks=[tensorboard])
